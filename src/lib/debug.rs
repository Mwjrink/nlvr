use ash::{extensions::ext::DebugReport, version::EntryV1_0, vk, Entry, Instance};
...
) -> Option<(DebugReport, vk::DebugReportCallbackEXT,),>
{
    ...
    let debug_report_callback = unsafe { debug_report.create_debug_report_callback(&create_info, None,).unwrap() };
